...
const IslandSnowLogo = () => (
    <div className="row">
            <div className="col">
                <img className="img-fluid rounded mx-auto d-block py-1"
                     src="https://courses.ics.hawaii.edu/ics314s23/morea/ui-frameworks/experience-islandsnow-bootstrap-logo.png"
                     alt="snow logo"></img>
            </div>
    </div>
...
const FullWidthImage = () => (
    <div className="row justify-content-center">
        <img src="https://courses.ics.hawaii.edu/ics314s23/morea/ui-frameworks/experience-islandsnow-bootstrap-main.png"
             alt="LOGO" className="img-fluid pt-4"></img>
    </div>
);
